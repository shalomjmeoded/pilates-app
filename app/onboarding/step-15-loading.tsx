...
export default function Step15Loading() {
  const { replaceNext, goToStep } = useOnboardingNavigation(14);
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <Button label="Go back" onPress={() => goToStep(13)} />
        </View>
      </SafeAreaView>
    );
  }
    ...
    return (
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.container}>
          ...
          <Text variant="bodyMuted" style={styles.subtitle}>
            Creating your daily rhythm for movement, nutrition, and milestones.
          </Text>
        </View>
      </SafeAreaView>
    );
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <Text variant="bodyMuted" style={styles.subtitle}>
          Personalizing your plan with calm, sustainable targets.
        </Text>
